...
class TBDeviceMqttClient:
    ...
    def __sending_thread_main(self):
        while not self.stopped:
            ...
            # Zwangsbremse am Ende jedes Schleifendurchlaufs
            sleep(0.05)
    ...
    def __timeout_check(self):
        while not self.stopped:
            ...
            # WICHTIG: Das sleep muss INNERHALB der while-Schleife stehen (4 Leerzeichen Einrueckung)
            sleep(0.2)
                ...
                for req_id in list(self.__responses.keys()):
                    if int(time()) > self.__responses[req_id]["timeout_ts"]:
                        try:
                            ...
                            pass
                # WICHTIG: Auch hier eine Bremse fuer jeden Durchlauf der Hauptschleife
                sleep(0.5)
